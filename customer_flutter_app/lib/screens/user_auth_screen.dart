...
class _UserAuthScreenState extends State<UserAuthScreen> {
  ...
  Future<void> _handleLogin() async {
    ...
    try {
      ...
      final String userId = res['user']?['id'] ?? 'mock_customer_user';
      try {
        await ApiService.registerDeviceToken(userId: userId, deviceToken: 'mock_customer_fcm_token');
      } catch (tokenErr) {
      ...
      try {
        await ApiService.registerDeviceToken(userId: 'mock_customer_user', deviceToken: 'mock_customer_fcm_token');
      } catch (_) {}
